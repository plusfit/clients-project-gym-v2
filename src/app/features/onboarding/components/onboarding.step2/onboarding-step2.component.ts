        ...
        if (step2Data) {
          ...
          try {
            ...
            const formValue = {
              ...
              history: {
                respiratory: this.convertDescriptionToBoolean(
                  step2Data.history.respiratory,
                ),
                cardiac: this.convertDescriptionToBoolean(
                  step2Data.history.cardiac,
                ),
                chirurgical: this.convertDescriptionToBoolean(
                  step2Data.history.chirurgical,
                ),
                injuries: this.convertDescriptionToBoolean(
                  step2Data.history.injuries,
                ),
              },
            };
